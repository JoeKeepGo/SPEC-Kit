...
5. Emit the non-persistent `SAGE_ACTIVE` routing marker in the first progress
   ...
   proof.
6. Prove one real project-native focused workflow and one handoff without
...
unchanged. If current authority cannot be identified, report that gap instead
of inferring it from old documents.
