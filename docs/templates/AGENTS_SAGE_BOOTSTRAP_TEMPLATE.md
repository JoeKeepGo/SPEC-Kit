...
Descendants inherit the same or narrower boundary; handoffs carry only the
compact boundary and selected profile identity with authority references,
never the activation marker. Do not cause nested Skill reloads or duplicate
reviews.
